...
import ar.edu.utn.frre.dacs.dacs2016.sepa.dao.ComercioDao;
import ar.edu.utn.frre.dacs.dacs2016.sepa.model.Comercio;
...
public class ComercioDaoImpl extends GenericDaoImpl<Comercio> implements
		ComercioDao {
	 ...
	 */
	@Override
	protected Class<Comercio> getEntityClazz() {
