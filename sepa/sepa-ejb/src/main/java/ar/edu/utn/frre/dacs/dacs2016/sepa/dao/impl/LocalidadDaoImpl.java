...
import ar.edu.utn.frre.dacs.dacs2016.sepa.dao.LocalidadDao;
import ar.edu.utn.frre.dacs.dacs2016.sepa.model.Localidad;
 ...
 */
@Stateless
@Local(LocalidadDao.class)
public class LocalidadDaoImpl extends GenericDaoImpl<Localidad> implements
		LocalidadDao {
